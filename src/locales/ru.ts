import {adminPaymentsRu} from "./admin-payments";
import {adminUserProfileRu} from "./admin-user-profile";
import {authTranslationRu} from "./auth";
import {commonTranslationRu} from "./common";
import {devicesTranslationsRu} from "./devices";
import {LocaleType} from "./en";
import {followersAdminRu} from "./followers";
...
import {userslistOptionsRu} from "./userslist-options";
import {personalizationTranslationRu} from "./personalization";

export const ru: LocaleType = {
    AdminPayments: adminPaymentsRu,
    AdminUserProfile: adminUserProfileRu,
    ...
    UserslistOptions: userslistOptionsRu,
    Personalization: personalizationTranslationRu,
};
